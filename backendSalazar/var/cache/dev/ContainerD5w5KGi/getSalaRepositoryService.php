 ...
 */
class getSalaRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SalaRepository.php';

        return $container->privates['App\\Repository\\SalaRepository'] = new \App\Repository\SalaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
