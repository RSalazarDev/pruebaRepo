 ...
 */
class Sala extends \App\Entity\Sala implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Sala' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Sala' . "\0" . 'estado', '' . "\0" . 'App\\Entity\\Sala' . "\0" . 'citas'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEstado(bool $estado): \App\Entity\Sala
    {
     ...
     * {@inheritDoc}
     */
    public function addCita(\App\Entity\Cita $cita): \App\Entity\Sala
    {
     ...
     * {@inheritDoc}
     */
    public function removeCita(\App\Entity\Cita $cita): \App\Entity\Sala
    {
