 ...
 */
class getMedicoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MedicoRepository' shared autowired service.
     *
     * @return \App\Repository\MedicoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MedicoRepository.php';

        return $container->privates['App\\Repository\\MedicoRepository'] = new \App\Repository\MedicoRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
